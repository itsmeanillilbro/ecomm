                    ...
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ Number::currency($order->grand_total,'NPR') }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Discount
                                    </p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ Number::currency(0,'NPR') }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                        ...
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            ...
                            <div class="flex items-start justify-between w-full">
                                ...
                                <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">{{ Number::currency(0,'NPR') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
