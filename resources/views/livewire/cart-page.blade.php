            ...
            <div class="row">
                <div class="col-xl-9 col-xs-12 col-sm-12 col-md-12 col-lg-8">
                    ...
                    <div class="cart-area">
                        <div class="cart-details">
                                ...
                                <div class="cart-all-pro">
                                    <div class="cart-pro">
                                        <div class="cart-pro-image">
                                            <img src="{{url('storage', $items['image'])}}" class="img-fluid h-16 w-16 mr-4"
                                                alt="image">
                                        </div>
                                        <div class="pro-details">
                                            ...
                                            <span
                                                class="cart-pro-price">{{Number::currency($items['unit_amount'], 'NPR')}}</span>
                                        </div>
                                    </div>
                                    <div class="qty-item">
                                        <div class="center">
                                            <div class="plus-minus">
                                                <button wire:click='decreaseQty({{$items['product_id']}})'
                                                    class="border rounded-md py-2 px-4 mr-2">-</button>
                                                <span class="text-center w-8">{{$items['quantity']}}</span>
                                                <button wire:click="increaseQty({{$items['product_id']}})"
                                                    class="border rounded-md py-2 px-4 ml-2">+</button>
                                            </div>
                                            <a href="#" class="pro-remove "
                                                wire:click='removeItem({{$items['product_id']}})'>Remove</a>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="text-center text-3xl py-20 font-extralight" >No Items in the Cart</div>
                ...
                <div class="col-xl-3 col-xs-12 col-sm-12 col-md-12 col-lg-4">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        @if($cart_items)
                            <a href="/checkout"
                                class=" block text-center btn-style2  text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
                        @endif
                    </div>
                </div>
            </div>
