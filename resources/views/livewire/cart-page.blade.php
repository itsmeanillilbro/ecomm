                                    ...
                                    <tr wire:key='{{$items['product_id']}}'>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                                <img class="h-16 w-16 mr-4" src="{{url('storage', $items['image'])}}"
                                                    alt="Product image">
                                                <span class="font-semibold">{{$items['name']}}</span>
                                            </div>
                                        </td>
                                        <td class="py-4">{{Number::currency($items['unit_amount'], 'NPR')}}</td>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                        ...
                                        <td class="py-4">{{Number::currency($items['total_amount'], 'NPR')}}</td>
                                        <td><button wire:click='removeItem({{$items['product_id']}})'
                                                class=" bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-600 hover:text-white hover:border-red-700">Remove</button>
                                        </td>
                                    </tr>
                                @empty

                                    <tr>
                                        <td colspan="5" class=" text-center py-10  text-4xl font-semibold text-slate-600">No
