                ...
                <div class="flex flex-wrap mb-24 -mx-3">
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    <li class="mb-4" wire:key="{{$category->id}}">
                                        <label for="{{$category->slug}}" class="flex items-center dark:text-gray-400 ">
                                            <input type="checkbox" wire:model.live="categories_select" class="w-4 h-4 mr-2"
                                ...
                                @foreach ($brands as $brand)
                                    <li class="mb-4" wire:key="{{$brand->id}}">
                                        <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                                            <input type="checkbox" wire:model.live="brands_select" id="{{$brand->slug}}"
                            ...
                            <ul>
                                <li class="mb-4">
                                    <label for="is_featured" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="is_featured" id="is_featured" value="1"
                                            class="w-4 h-4 mr-2">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                            <div>
                                <div class="font-semibold dark:text-white mb-2">{{Number::currency($pricee, 'NPR')}}
                                </div>
                                <input type="range" wire:model.live="pricee"
                                    class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                    max="500000" value="100000" step="50000">
                                <div class="flex justify-between ">
                                    <span
                                        class="inline-block text-lg font-semibold text-blue-400 ">{{Number::currency(1000, 'NPR')}}</span>
                                    <span
                                        class="inline-block text-lg font-semibold text-blue-400 ">{{Number::currency(500000, 'NPR')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                                    <div class="border border-gray-300 dark:border-gray-700">
                                        ...
                                        <div class="p-3 ">
                                            ...
                                            <p class="text-lg ">
                                                <span
                                                    class="text-green-600 dark:text-green-600">{{Number::currency($product->price, 'NPR')}}</span>
                                            </p>
                                        </div>
